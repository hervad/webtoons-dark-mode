...
(function () {
    ...
    const theme = `
        ...
        /* Lift each panel off the dark background with a drop shadow + hairline
           edge. box-shadow is purely decorative and doesn't alter image colors. */
        img._images {
            box-shadow:
                0 0 0 1px rgba(255,255,255,.07),
                0 6px 28px rgba(0,0,0,.7) !important;
